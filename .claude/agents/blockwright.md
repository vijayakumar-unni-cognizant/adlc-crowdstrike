...
tools: "Read, Write, Edit, Glob, Grep, Bash, PowerShell, Skill, WebFetch, AskUserQuestion, mcp__figma__get_design_context, mcp__figma__get_screenshot, mcp__figma__get_metadata, mcp__figma__get_variable_defs, mcp__figma__search_design_system, mcp__figma__download_assets"
model: sonnet
color: yellow
---
